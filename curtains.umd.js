...
(function (global, factory) {
      ...
      },
      {
        ...
        value: function addToRenderTargetsStack(plane) {
          ...
          var renderTargetsPlanes = this.renderer.planes.filter(function (el) {
            return (
              el.type !== "PingPongPlane" && el.target && el.uuid !== plane.uuid
            );
      ...
      },
      {
        ...
        value: function addToRegularPlaneStack(plane) {
          ...
          var planeStack = this.renderer.planes.filter(function (el) {
            return (
              el.type !== "PingPongPlane" &&
              !el.target &&
              el._transparent === plane._transparent &&
              el.uuid !== plane.uuid
            );
          ...
          for (var i = planeStack.length - 1; i >= 0; i--) {
            if (
              planeStack[i]._geometry.definition.id ===
              plane._geometry.definition.id
            ) {
              siblingPlaneIndex = i + 1;
              break;
            }
      ...
      },
      {
        ...
        value: function setPlaneRenderOrder(plane) {
          ...
          if (plane.target) {
            ...
            var planeStack = plane._transparent
              ? this.stacks.transparent
              : this.stacks.opaque; // if the first drawn scene pass does not handle depth, we'll have to sort them in the inverse order

            var scenePassWithoutDepth = this.stacks.scenePasses.find(function (
              pass,
              index
            ) {
      ...
      },
      {
        ...
        value: function getProgramFromShaders(vsCode, fsCode) {
          ...
          return this.programs.find(function (element) {
            return (
              _this.isSameShader(element.vsCode, vsCode) &&
              _this.isSameShader(element.fsCode, fsCode)
            );
          });
        },
        /***
          ...
          if (isRestored) {
            for (var _i2 = 0; _i2 < this.shaderPasses.length; _i2++) {
              if (!this.shaderPasses[_i2]._canDraw) {
                ...
                for (
                  var _j = 0;
                  _j < this.shaderPasses[_i2].textures.length;
                  _j++
                ) {
        ...
        value: function setSize() {
          ...
          if (isSafari && iOS) {
            ...
            this._boundingRect.top =
              getTopOffset(this.container) * this.pixelRatio;
          }
        ...
        value: function setFaceCulling(cullFace) {
          if (this.state.cullFace !== cullFace) {
            ...
            if (cullFace === "none") {
              ...
              var faceCulling =
                cullFace === "front" ? this.gl.FRONT : this.gl.BACK;
      ...
      },
      {
        ...
        value: function dispose() {
          ...
          var disposeQueue = this.nextRender.add(function () {
            if (
              _this6.planes.length === 0 &&
              _this6.shaderPasses.length === 0 &&
              _this6.renderTargets.length === 0
            ) {
              ...
              _this6.canvas.removeEventListener(
                "webgllost",
                _this6._contextLostHandler,
                false
              );

              _this6.canvas.removeEventListener(
                "webglrestored",
                _this6._contextRestoredHandler,
                false
              ); // lose context
  ...
  var Curtains = /*#__PURE__*/ (function () {
    function Curtains() {
      var _ref3 =
        ...
        premultipliedAlpha =
          _ref3$premultipliedAl === void 0 ? false : _ref3$premultipliedAl,
        ...
        failIfMajorPerformanceCaveat =
          _ref3$failIfMajorPerf === void 0 ? true : _ref3$failIfMajorPerf,
        _ref3$preserveDrawing = _ref3.preserveDrawingBuffer,
        preserveDrawingBuffer =
          _ref3$preserveDrawing === void 0 ? false : _ref3$preserveDrawing,
        ...
        pixelRatio =
          _ref3$pixelRatio === void 0
            ? window.devicePixelRatio || 1
            : _ref3$pixelRatio,
        _ref3$renderingScale = _ref3.renderingScale,
        renderingScale =
          _ref3$renderingScale === void 0 ? 1 : _ref3$renderingScale,
      ...
      },
      {
        ...
        value: function _onRendererDisposed() {
          ...
          this._animationFrameID &&
            window.cancelAnimationFrame(this._animationFrameID); // remove event listeners
      ...
      if (uniforms) {
        for (var key in uniforms) {
          ...
          this.uniforms[key] = {
            ...
            value:
              uniform.value.clone && typeof uniform.value.clone === "function"
                ? uniform.value.clone()
                : uniform.value,
            update: null,
          };
    ...
    _createClass(Uniforms, [
          ...
          if (this.uniforms) {
            for (var key in this.uniforms) {
              ...
              if (uniform._internalFormat === "Vec2") {
                ...
                JSON.stringify(uniform.lastValue)
              ) {
                // compare two arrays
      ...
      },
      {
        ...
        value: function setUniform2iv(uniform) {
          uniform._internalFormat === "Vec2"
            ? this.gl.uniform2iv(uniform.location, [
                uniform.value.x,
                uniform.value.y,
              ])
      ...
      },
      {
        ...
        value: function setUniform2fv(uniform) {
          uniform._internalFormat === "Vec2"
            ? this.gl.uniform2fv(uniform.location, [
                uniform.value.x,
                uniform.value.y,
              ])
      ...
      },
      {
        ...
        value: function setUniform3iv(uniform) {
          uniform._internalFormat === "Vec3"
            ? this.gl.uniform3iv(uniform.location, [
                uniform.value.x,
                uniform.value.y,
                uniform.value.z,
              ])
      ...
      },
      {
        ...
        value: function setUniform3fv(uniform) {
          uniform._internalFormat === "Vec3"
            ? this.gl.uniform3fv(uniform.location, [
                uniform.value.x,
                uniform.value.y,
                uniform.value.z,
              ])
      ...
      },
      {
        ...
        value: function setUniform4iv(uniform) {
          uniform._internalFormat === "Quat"
            ? this.gl.uniform4iv(uniform.location, [
                uniform.value.elements[0],
                uniform.value.elements[1],
                uniform.value.elements[2],
                uniform.value[3],
      ...
      },
      {
        ...
        value: function setUniform4fv(uniform) {
          uniform._internalFormat === "Quat"
            ? this.gl.uniform4fv(uniform.location, [
                uniform.value.elements[0],
                uniform.value.elements[1],
                uniform.value.elements[2],
                uniform.value[3],
  ...
  var Program = /*#__PURE__*/ (function () {
    function Program(renderer) {
      ...
      this.parent = parent;
      this.defaultVsCode =
        this.parent.type === "Plane" ? planeVS$1 : shaderPassVS$1;
      this.defaultFsCode =
        this.parent.type === "Plane" ? planeFS$1 : shaderPassFS$1; // use the vertex shader specified or fallback to a default one
    ...
    _createClass(Program, [
       ...
       ***/
          function setupProgram() {
            var existingProgram = this.renderer.cache.getProgramFromShaders(
              this.vsCode,
              this.fsCode
        ...
        value: function createProgram() {
          ...
          if (!this.activeUniforms || !this.activeAttributes) {
            ...
            for (var i = 0; i < numUniforms; i++) {
              ...
              if (
                activeUniform.type === this.gl.FLOAT_MAT4 &&
                activeUniform.name !== "uMVMatrix" &&
                activeUniform.name !== "uPMatrix"
              ) {
      ...
      },
      {
        ...
        value: function createUniforms(uniforms) {
          this.uniformsManager = new Uniforms(
            this.renderer,
            this.program,
            uniforms
          ); // set them right away
    ...
    _createClass(Geometry, [
      ...
      },
      {
        ...
        value: function setVerticesUVs() {
          ...
          var cachedGeometry = this.renderer.cache.getGeometryFromID(
            this.definition.id
          );
      ...
      },
      {
        ...
        value: function initAttributes() {
          ...
          for (var key in this.attributes) {
            ...
            this.attributes[key].isActive =
              this.program.activeAttributes.includes(this.attributes[key].name); // if attribute is not active, no need to go further
  ...
  var Mat4 = /*#__PURE__*/ (function () {
    ...
    _createClass(Mat4, [
      ...
      },
      {
        ...
        value: function composeFromOrigin(
          translation,
          quaternion,
          scale,
          origin
          ...
          matrix[14] =
            translation.z + oz - (out2 * ox + out6 * oy + out10 * oz);
          matrix[15] = 1;
          return this;
        },
      },
  ...
  var Vec3 = /*#__PURE__*/ (function () {
    ...
    _createClass(Vec3, [
      ...
      },
      {
        ...
        value: function equals(vector) {
          return (
            this._x === vector.x && this._y === vector.y && this._z === vector.z
          );
        },
        /***
       Normalize this vector
      ...
      },
      {
        ...
        value: function applyMat4(matrix) {
          ...
          w = w || 1;
          this._x =
            (mArray[0] * x + mArray[4] * y + mArray[8] * z + mArray[12]) / w;
          this._y =
            (mArray[1] * x + mArray[5] * y + mArray[9] * z + mArray[13]) / w;
          this._z =
            (mArray[2] * x + mArray[6] * y + mArray[10] * z + mArray[14]) / w;
          return this;
        },
        /***
  ...
  var Texture = /*#__PURE__*/ (function () {
    function Texture(renderer) {
      ...
      var _ref6 =
        ...
        isFBOTexture =
          _ref6$isFBOTexture === void 0 ? false : _ref6$isFBOTexture,
        ...
        floatingPoint =
          _ref6$floatingPoint === void 0 ? "none" : _ref6$floatingPoint,
        _ref6$premultiplyAlph = _ref6.premultiplyAlpha,
        premultiplyAlpha =
          _ref6$premultiplyAlph === void 0 ? false : _ref6$premultiplyAlph,
        ...
        generateMipmap =
          _ref6$generateMipmap === void 0 ? null : _ref6$generateMipmap,
        wrapS = _ref6.wrapS,
        wrapT = _ref6.wrapT,
    ...
    _createClass(Texture, [
      ...
      },
      {
        ...
        value: function _setParent() {
          ...
          this._textureMatrix.name = this._samplerName
            ...
            : "uTextureMatrix" + this.index; // if the parent has a program it means its not a render target texture
          ...
          if (this._parent._program) {
            ...
            if (this._copyOnInit) {
              ...
              var waitForOriginalTexture = this.renderer.nextRender.add(
                function () {
                  if (
                    _this14._copiedFrom._canDraw &&
                    _this14._copiedFrom._uploaded
                  ) {
        ...
        value: function _setTextureUniforms() {
          ...
          for (var i = 0; i < activeUniforms.textures.length; i++) {
            if (activeUniforms.textures[i] === this._sampler.name) {
              ...
              var isTextureMatrixActive = activeUniforms.textureMatrices.find(
        ...
        value: function setSource(source) {
          ...
          if (!this._sourceLoaded) {
            ...
            this.renderer.nextRender.add(function () {
              return (
                _this16._onSourceLoadedCallback &&
                _this16._onSourceLoadedCallback()
              );
            });
          ...
          var sourceType =
            source.tagName.toUpperCase() === "IMG"
              ? "image"
              : source.tagName.toLowerCase(); // somehow if the texture type changes from image to video or canvas, the cache won't work anymore
          ...
          if (this._useCache) {
            var cachedTexture =
              this.renderer.cache.getTextureFromSource(source); // if we have a cached texture, just copy it
            ...
            if (cachedTexture && cachedTexture.uuid !== this.uuid) {
              ...
              if (!this._uploaded) {
                ...
                this.renderer.nextRender.add(function () {
                  return (
                    _this16._onSourceUploadedCallback &&
                    _this16._onSourceUploadedCallback()
                  );
                });
                this._uploaded = true;
          ...
          this._globalParameters.premultiplyAlpha =
            this._globalParameters.shouldPremultiplyAlpha; // upload our webgl texture only if it is an image
      ...
      },
      {
        ...
        value: function _upload() {
          ...
          if (!this._uploaded) {
            ...
            this.renderer.nextRender.add(function () {
              return (
                _this18._onSourceUploadedCallback &&
                _this18._onSourceUploadedCallback()
              );
            });
            this._uploaded = true;
      ...
      },
      {
        ...
        value: function _getSizes() {
          ...
          var parentHeight =
            this._parent._boundingRect.document.height * scale.y;
          ...
          if (parentRatio > sourceRatio) {
            ...
            yOffset = Math.min(
              0,
              parentHeight - parentWidth * (1 / sourceRatio)
            );
      ...
      },
      {
        ...
        value: function setScale(scale) {
          ...
          scale
            .sanitizeNaNValuesWith(this.scale)
            .max(tempVec2.set(0.001, 0.001));
    ...
    _createClass(TextureLoader, [
        ...
        value: function _sourceLoaded(source, texture, callback) {
          ...
          if (!texture._sourceLoaded) {
            ...
            if (this._parent) {
              ...
              this.renderer.nextRender.add(function () {
                return (
                  _this19._parent._onLoadingCallback &&
                  _this19._parent._onLoadingCallback(texture)
                );
              });
            } // execute callback
        ...
        value: function _getSourceType(source) {
          ...
          if (typeof source === "string") {
            ...
            if (
              ...
              source.match(/\.(webm|mp4|mpg|mpeg|avi|ogg|ogm|ogv|mov|av1)$/) !==
              null
            ) {
              sourceType = "video";
            }
      ...
      },
      {
        ...
        value: function _createImage(source) {
          ...
          if (
            ...
            !source.hasAttribute("crossOrigin")
          ) {
            var image = new Image();
            ...
            if (typeof source === "string") {
              ...
              source.hasAttribute("data-sampler") &&
                image.setAttribute(
                  "data-sampler",
                  source.getAttribute("data-sampler")
                );
            }
      ...
      },
      {
        ...
        value: function _createVideo(source) {
          ...
          if (
            typeof source === "string" ||
            source.getAttribute("crossOrigin") === null
          ) {
          ...
          switch (sourceType) {
            ...
            default:
              this._sourceLoadError(
                source,
                errorCallback,
                "this source could not be converted into a texture: " + source
              );
      ...
      },
      {
        ...
        value: function loadImage(source) {
          ...
          if (cachedTexture) {
            options.sampler =
              typeof source !== "string" && source.hasAttribute("data-sampler")
                ? source.getAttribute("data-sampler")
                : options.sampler;
            ...
            this._parent &&
              this._addToParent(_texture, cachedTexture.source, "image"); // that's all!
          ...
          options.sampler = image.hasAttribute("data-sampler")
            ? image.getAttribute("data-sampler")
            : options.sampler; // create a new texture that will use our image later

          var texture = new Texture(this.renderer, options); // add a new entry in our elements array

          var el = this._addElement(
            image,
            texture,
            successCallback,
            errorCallback
          ...
          if (image.complete) {
            ...
            image
              .decode()
              .then(
                this._sourceLoaded.bind(this, image, texture, successCallback)
              )
              ["catch"](function () {
        ...
        value: function loadVideo(source) {
          ...
          if (this._parent) {
            options = Object.assign(
              textureOptions,
              this._parent._texturesOptions
            );
          }

          options.loader = this;
          options.sampler = video.hasAttribute("data-sampler")
            ? video.getAttribute("data-sampler")
            : options.sampler; // create a new texture that will use our video later
          ...
          if ("requestVideoFrameCallback" in HTMLVideoElement.prototype) {
            ...
            texture._videoFrameCallbackID = video.requestVideoFrameCallback(
              el.videoFrameCallback
            );
          }
        },
        /***
      ...
      },
      {
        ...
        value: function loadCanvas(source) {
          ...
          options.loader = this;
          options.sampler = source.hasAttribute("data-sampler")
            ? source.getAttribute("data-sampler")
            : options.sampler; // create a new texture that will use our source later
          ...
          if (el) {
            if (texture.sourceType === "image") {
              ...
              if (el.videoFrameCallback && texture._videoFrameCallbackID) {
                el.source.cancelVideoFrameCallback(
                  texture._videoFrameCallbackID
                );
              }
  ...
  var PlaneTextureLoader = /*#__PURE__*/ (function (_TextureLoader) {
    ...
    function PlaneTextureLoader(renderer, parent) {
      ...
      if (
        _this20._parent.type !== "Plane" &&
        _this20._parent.type !== "PingPongPlane" &&
        _this20._parent.type !== "ShaderPass"
      ) {
        throwWarning(
          _this20.type + ": Wrong parent type assigned to this loader"
        );
  ...
  var Mesh = /*#__PURE__*/ (function () {
    function Mesh(renderer) {
      ...
      var _ref8 =
        ...
        widthSegments =
          _ref8$widthSegments === void 0 ? 1 : _ref8$widthSegments,
        _ref8$heightSegments = _ref8.heightSegments,
        heightSegments =
          _ref8$heightSegments === void 0 ? 1 : _ref8$heightSegments,
        ...
        texturesOptions =
          _ref8$texturesOptions === void 0 ? {} : _ref8$texturesOptions,
        _ref8$crossOrigin = _ref8.crossOrigin,
        crossOrigin =
          _ref8$crossOrigin === void 0 ? "anonymous" : _ref8$crossOrigin;
        ...
        value: function setRenderOrder() {
          var renderOrder =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : 0;
          renderOrder = isNaN(renderOrder)
            ? this.renderOrder
            : parseInt(renderOrder);
      ...
      },
      {
        ...
        value: function createTexture() {
          ...
          var texture = new Texture(
            this.renderer,
            Object.assign(textureOptions, this._texturesOptions)
          ...
          this.loader.loadImage(
            ...
            function (source, error) {
              if (!_this26.renderer.production) {
                throwWarning(
                  _this26.type + ": There has been an error:\n",
                  error,
          ...
          this.loader.loadVideo(
            ...
            function (source, error) {
              if (!_this27.renderer.production) {
                throwWarning(
                  _this27.type + ": There has been an error:\n",
                  error,
            ...
            if (texture.sourceType === "video") {
              ...
              if (playPromise !== undefined) {
                playPromise["catch"](function (error) {
                  if (!_this28.renderer.production)
                    throwWarning(
                      _this28.type + ": Could not play the video : ",
                      error
                    );
                });
              }
      ...
      },
      {
        ...
        value: function _draw() {
          ...
          for (var i = 0; i < this.textures.length; i++) {
            ...
            if (
              this.textures[i]._sampler.isActive &&
              !this.textures[i]._sampler.isTextureBound
            ) {
              return;
            }
          } // the draw call!
  ...
  var DOMMesh = /*#__PURE__*/ (function (_Mesh) {
    ...
    function DOMMesh(renderer, htmlElement) {
      ...
      vertexShaderID =
        vertexShaderID ||
        (htmlElement && htmlElement.getAttribute("data-vs-id"));
      fragmentShaderID =
        fragmentShaderID ||
        (htmlElement && htmlElement.getAttribute("data-fs-id"));
      ...
      if (!_this29.htmlElement || _this29.htmlElement.length === 0) {
        if (!_this29.renderer.production)
          throwWarning(
            _this29.type +
    ...
    _createClass(DOMMesh, [
      ...
      },
      {
        ...
        value: function resize() {
          ...
          this.renderer.nextRender.add(function () {
            return (
              _this30._onAfterResizeCallback && _this30._onAfterResizeCallback()
            );
          });
        },
        /*** INTERACTION ***/
      ...
      },
      {
        ...
        value: function mouseToPlaneCoords(mouseCoordinates) {
          ...
          var scaleAdjustment = tempVec2a.set(
            (this._boundingRect.document.width -
              this._boundingRect.document.width * scale.x) /
              2,
            (this._boundingRect.document.height -
              this._boundingRect.document.height * scale.y) /
              2
          ...
          return tempVec2a.set(
            ((mouseCoordinates.x - planeBoundingRect.left) /
              planeBoundingRect.width) *
              2 -
              1,
            1 -
              ((mouseCoordinates.y - planeBoundingRect.top) /
  ...
  var Plane = /*#__PURE__*/ (function (_DOMMesh) {
    ...
    function Plane(renderer, htmlElement) {
      ...
      var _ref11 =
        ...
        transparent =
          _ref11$transparent === void 0 ? false : _ref11$transparent,
        _ref11$drawCheckMargi = _ref11.drawCheckMargins,
        drawCheckMargins =
          _ref11$drawCheckMargi === void 0
            ? {
                top: 0,
                right: 0,
                bottom: 0,
        ...
        autoloadSources =
          _ref11$autoloadSource === void 0 ? true : _ref11$autoloadSource,
    ...
    _createClass(Plane, [
        ...
        value: function _setMVMatrix() {
          if (this._updateMVMatrix) {
            ...
            this._matrices.modelView.matrix.elements[14] -=
              this.camera.position.z; // our modelViewProjection matrix, useful for bounding box calculations and frustum culling
      ...
      },
      {
        ...
        value: function _documentToWorldSpace(vector) {
          return tempWorldPos2.set(
            ((vector.x * this.renderer.pixelRatio) /
              this.renderer._boundingRect.width) *
              this._boundingRect.world.ratios.width,
            -(
              (vector.y * this.renderer.pixelRatio) /
              this.renderer._boundingRect.height
      ...
      },
      {
        ...
        value: function _setWorldPosition() {
          ...
          this._boundingRect.world.top =
            ((containerCenter.y - planeCenter.y) /
              this.renderer._boundingRect.height) *
            this._boundingRect.world.ratios.height;
          this._boundingRect.world.left =
            ((planeCenter.x - containerCenter.x) /
              this.renderer._boundingRect.width) *
            this._boundingRect.world.ratios.width;
        },
        /*** TRANSFORMATIONS ***/
      ...
      },
      {
        ...
        value: function setScale(scale) {
          ...
          scale
            .sanitizeNaNValuesWith(this.scale)
            .max(tempScale.set(0.001, 0.001)); // only apply if values changed
      ...
      },
      {
        ...
        value: function _setTranslation() {
          ...
          if (!this.relativeTranslation.equals(worldPosition)) {
            worldPosition = this._documentToWorldSpace(
          ...
          this._translation.set(
            ...
            this._boundingRect.world.top + worldPosition.y, //this._translation.z,
            this.relativeTranslation.z / this.camera.CSSPerspective
          ); // we should update the plane mvMatrix
      ...
      },
      {
        ...
        value: function updateScrollPosition(lastXDelta, lastYDelta) {
          ...
          if (lastXDelta || lastYDelta) {
            ...
            this._boundingRect.document.top +=
              lastYDelta * this.renderer.pixelRatio;
            this._boundingRect.document.left +=
              lastXDelta * this.renderer.pixelRatio; // apply them
      ...
      },
      {
        ...
        value: function _getNearPlaneIntersections(
          corners,
          mvpCorners,
          clippedCorners
        ) {
          ...
          if (clippedCorners.length === 1) {
            ...
            if (clippedCorners[0] === 0) {
              ...
              mvpCorners[0] = this._getIntersection(
                mvpCorners[1],
                tempCulledCorner1.set(0.95, 1, 0).applyMat4(mVPMatrix)
              ); // get intersection iterating from bottom left

              mvpCorners.push(
                this._getIntersection(
                  mvpCorners[3],
                  tempCulledCorner2.set(-1, -0.95, 0).applyMat4(mVPMatrix)
                )
              );
            } else if (clippedCorners[0] === 1) {
              // top right is culled
              // get intersection iterating from top left
              mvpCorners[1] = this._getIntersection(
                mvpCorners[0],
                tempCulledCorner1.set(-0.95, 1, 0).applyMat4(mVPMatrix)
              ...
              // get intersection iterating from bottom left
              mvpCorners[2] = this._getIntersection(
                mvpCorners[3],
                tempCulledCorner1.set(-0.95, -1, 0).applyMat4(mVPMatrix)
              ); // get intersection iterating from top right
              ...
              // get intersection iterating from bottom right
              mvpCorners[3] = this._getIntersection(
                mvpCorners[2],
                tempCulledCorner1.set(0.95, -1, 0).applyMat4(mVPMatrix)
              ); // get intersection iterating from top left
            ...
            if (clippedCorners[0] === 0 && clippedCorners[1] === 1) {
              ...
              mvpCorners[0] = this._getIntersection(
                mvpCorners[3],
                tempCulledCorner1.set(-1, -0.95, 0).applyMat4(mVPMatrix)
              );
              mvpCorners[1] = this._getIntersection(
                mvpCorners[2],
                tempCulledCorner2.set(1, -0.95, 0).applyMat4(mVPMatrix)
              ...
              mvpCorners[2] = this._getIntersection(
                mvpCorners[3],
                tempCulledCorner2.set(-0.95, -1, 0).applyMat4(mVPMatrix)
              );
       ...
       ***/
          function _getWorldCoords() {
            ...
            for (var i = 0; i < corners.length; i++) {
              var mvpCorner = corners[i].applyMat4(
                this._matrices.modelViewProjection.matrix
              );
            ...
            if (clippedCorners.length) {
              mvpCorners = this._getNearPlaneIntersections(
                corners,
                mvpCorners,
                clippedCorners
              );
       ...
       ***/
          function _computeWebGLBoundingRect() {
            ...
            this._boundingRect.worldToDocument = {
              ...
              top:
                screenBBox.top * this.renderer._boundingRect.height +
                this.renderer._boundingRect.top,
              left:
                screenBBox.left * this.renderer._boundingRect.width +
                this.renderer._boundingRect.left,
              // add left and width to get right property
              right:
                screenBBox.left * this.renderer._boundingRect.width +
                this.renderer._boundingRect.left +
                screenBBox.width * this.renderer._boundingRect.width,
              // add top and height to get bottom property
              bottom:
                screenBBox.top * this.renderer._boundingRect.height +
                this.renderer._boundingRect.top +
                screenBBox.height * this.renderer._boundingRect.height,
            };
          },
        /***
      ...
      },
      {
        ...
        value: function _shouldDrawCheck() {
          ...
          if (
            Math.round(actualPlaneBounds.right) <=
              this.renderer._boundingRect.left ||
            Math.round(actualPlaneBounds.left) >=
              this.renderer._boundingRect.left +
                this.renderer._boundingRect.width ||
            Math.round(actualPlaneBounds.bottom) <=
              this.renderer._boundingRect.top ||
            Math.round(actualPlaneBounds.top) >=
              this.renderer._boundingRect.top +
                this.renderer._boundingRect.height
          ) {
            if (this._shouldDraw) {
              ...
              this.renderer.nextRender.add(function () {
                return (
                  _this33._onLeaveViewCallback && _this33._onLeaveViewCallback()
                );
              });
            }
          } else {
            if (!this._shouldDraw) {
              ...
              this.renderer.nextRender.add(function () {
                return (
                  _this33._onReEnterViewCallback &&
                  _this33._onReEnterViewCallback()
                );
              });
            }
      ...
      },
      {
        ...
        value: function mouseToPlaneCoords(mouseCoordinates) {
          ...
          if (
            identityQuat.equals(this.quaternion) &&
            defaultTransformOrigin.equals(this.transformOrigin)
          ) {
            return _get(
              _getPrototypeOf(Plane.prototype),
              "mouseToPlaneCoords",
              this
            ).call(this, mouseCoordinates);
          } else {
            // raycasting
            ...
            var rayDirection = tempRayDirection.set(
              worldMouse.x,
              worldMouse.y,
              -0.5
            ...
            if (Math.abs(denominator) >= 0.0001) {
              var inverseViewMatrix = this._matrices.world.matrix
                .getInverse()
                .multiply(this.camera.viewMatrix); // get the plane's center coordinates
              // start with our transform origin point

              var planeOrigin = this._boundingRect.world.transformOrigin
                .clone()
                .add(this._translation); // rotate our transform origin about world center

              var rotatedOrigin = tempRotatedOrigin.set(
              ...
              var distance =
                planeNormals.dot(planeOrigin.clone().sub(rayOrigin)) /
                denominator;
  ...
  var RenderTarget = /*#__PURE__*/ (function () {
    function RenderTarget(renderer) {
      var _ref12 =
        ...
        texturesOptions =
          _ref12$texturesOption === void 0 ? {} : _ref12$texturesOption;
      ...
      this._maxSize = {
        width: maxWidth
          ? Math.min(this.renderer.state.maxTextureSize / 4, maxWidth)
          : this.renderer.state.maxTextureSize / 4,
        // enough!
        height: maxHeight
          ? Math.min(this.renderer.state.maxTextureSize / 4, maxHeight)
          : this.renderer.state.maxTextureSize / 4,
      };
      this._minSize = {
  ...
  var PingPongPlane = /*#__PURE__*/ (function (_Plane) {
    ...
    function PingPongPlane(curtains, htmlElement) {
      ...
      var _ref14 =
        ...
        sampler =
          _ref14$sampler === void 0 ? "uPingPongTexture" : _ref14$sampler,
      ...
      _this35._onRenderCallback = function () {
        ...
        if (
          ...
          _this35.writePass &&
          _this35.textures[0] &&
          _this35.textures[0]._uploaded
        ) {
          _this35.setRenderTarget(_this35.writePass);
        }

        _this35._onPingPongRenderCallback &&
          _this35._onPingPongRenderCallback();
      };
      ...
      _this35._onAfterRenderCallback = function () {
        ...
        _this35._onPingPongAfterRenderCallback &&
          _this35._onPingPongAfterRenderCallback();
      };
    ...
    _createClass(PingPongPlane, [
      ...
      },
      {
        ...
        value: function remove() {
          ...
          _get(_getPrototypeOf(PingPongPlane.prototype), "remove", this).call(
            this
          );
        },
      },
  ...
  var FXAAPass = /*#__PURE__*/ (function (_ShaderPass) {
    ...
    function FXAAPass(curtains) {
      ...
      _this37.uniforms.resolution.value = [
        _this37.renderer._boundingRect.width,
        _this37.renderer._boundingRect.height,
